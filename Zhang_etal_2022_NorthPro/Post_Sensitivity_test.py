...
plt.fill_between(x, -1000, y, color=(200/255, 200/255, 200/255), alpha=1)
...
plt.text(200, 800, 'N Apennines', ha='center')
plt.text(410, 200, 'Adriatic Sea', ha='center')
plt.text(550, 1100, 'N Dinarides', ha='center')
plt.text(800, 300, 'Pannonian Basin', ha='center')
###################################################
ax.set_xlim(np.min(measured_topo[:,0]), np.max(measured_topo[:,0]))
ax.set_ylim(-1000.0, 1300.0)
...
Dytopo_total = np.loadtxt('Sub_mantle_NE20_Wet/N_Ext_9.mat_DynaTopo.txt') 
# ax.plot(Dytopo_total[:,0] - 200, Dytopo_total[:,1], '-', color='blue', label=r'$\eta_{sub\_mantle}=HK03$')

Dytopo_total_1e19 = np.loadtxt('Sub_mantle_1e19/N_Ext_1.mat_DynaTopo.txt') 
# ax.plot(Dytopo_total_1e19[:,0] - 200, Dytopo_total_1e19[:,1], '-', color= 'brown', label=r'$\eta_{sub\_mantle}=1e19$')

# Dytopo = np.loadtxt('Sub_mantle_1e20/N_Ext_1.mat_DynaTopo.txt') 
# ax.plot(Dytopo[:,0] - 200, Dytopo[:,1], '-', label=r'$\eta_{sub\_mantle}=1e20$')

Dytopo_total_5e22 = np.loadtxt('Sub_mantle_5e22/N_Ext_1.mat_DynaTopo.txt') 
# ax.plot(Dytopo_total_5e22[:,0] - 200, Dytopo_total_5e22[:,1], '-', color= 'orange', label=r'$\eta_{sub\_mantle}=1e22$')
...
Dytopo_NoSlab = np.loadtxt('No_slab_Sub_mantle_NE20_Wet/N_Ext_9.mat_DynaTopo.txt') 
# ax.plot(Dytopo_NoSlab[:,0] - 200, Dytopo_NoSlab[:,1], '-', color='blue', label=r'$\eta_{sub\_mantle}=HK03$')

Dytopo_NoSlab_1e19 = np.loadtxt('No_slab_Sub_mantle_1e19/N_Ext_0.mat_DynaTopo.txt') 
# ax.plot(Dytopo_NoSlab_1e19[:,0] - 200, Dytopo_NoSlab_1e19[:,1], '-', color= 'brown', label=r'$\eta_{sub\_mantle}=1e19$')
...
# ax.plot(Dytopo_NoSlab_5e22[:,0] - 200, Dytopo_NoSlab_5e22[:,1], '-', color= 'orange', label=r'$\eta_{sub\_mantle}=1e22$')
...
ax.plot(Dytopo_total[:,0] - 200, Dytopo_Deta_total[:,1], '-',color='blue', label=r'$\eta_{sub\_mantle}=HK03$')

Dytopo_Deta_1e19 = Dytopo_total_1e19 - Dytopo_NoSlab_1e19
ax.plot(Dytopo_total_1e19[:,0] - 200, Dytopo_Deta_1e19[:,1], '-',color= 'brown',   label=r'$\eta_{sub\_mantle}=1e19$')
...
ax.plot(Dytopo_total_5e22[:,0] - 200, Dytopo_Deta_5e22[:,1], '-', color= 'orange', label=r'$\eta_{sub\_mantle}=1e22$')
