...
- The model geometry, input files, computational domain, and numerical parameters are initialized through: `Zhang_Northern_ext.py` or  `Zhang\_Southern\_ext.py.
...
- Compare the reproduced results with the reference outputs archived in `Zhang_etal_2022_NorthPro/` and `Zhang_etal_2024_SouthPro/`.
